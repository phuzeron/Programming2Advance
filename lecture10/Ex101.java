 ...
 * @author phuzeron
 */
@WebServlet(name = "Ex101", urlPatterns = {"/lecture10/Ex101"})
public class Ex101 extends HttpServlet{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        try(PrintWriter out = response.getWriter()){
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Ex101 at " + request.getContextPath() + "</h1>");
            ...
            //SQL文の発行(挿入)
            String sql2 = "insert into T_STUDENT_A (FULLNAME, GAKUBU_ID, GRADE) values ('松田聖子', 1, 4)";
